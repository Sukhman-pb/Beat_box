...
//use this function in the buttons to read from two channels and have update the 
//bulkEvents1 and bulkEvents2 for rotaryEncoder Button and joyStick Button
int Gpio_waitForLineChangeSingle(
    struct GpioLine* line1,
    struct gpiod_line_bulk *bulkEvents 
